                ...
                <form action="<%= request.getContextPath() %>/LoginAdminServlet" method="post">
                    <div class="form-group">
                        ...
                        <div class="position-relative has-icon-right">
                            <input type="text" id="exampleInputUsername" class="form-control input-shadow" placeholder="Enter Username" name="nomAdmin" value="admin">
                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative has-icon-right">
                            <input type="password" id="exampleInputPassword" class="form-control input-shadow" placeholder="Enter Password" value="admin" name="mdp">
                            <div class="form-control-position">
                                <i class="icon-lock"></i>
                            </div>
                        </div>
