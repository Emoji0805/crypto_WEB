...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
        ...
        <ul class="sidebar-menu do-nicescrol">
            ...
            <li>
                <a href="${pageContext.request.contextPath}/CoursServlet?mode=not_random">
                    <i class="zmdi zmdi-trending-up"></i> <span>Cours des Cryptos</span>
                </a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/GestionPortefeuilleServlet">
                    <i class="zmdi zmdi-balance-wallet"></i> <span>Mon Portefeuille</span>
                </a>
            </li>

            <li>
                <a href="${pageContext.request.contextPath}/HistoriqueVenteAchat">
                    <i class="zmdi zmdi-format-list-bulleted"></i> <span>Historique Vente et Achat</span>
                </a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/HistoriqueRetraitDepot?mode=all">
                    <i class="zmdi zmdi-format-list-bulleted"></i> <span>Historique Retrait et Depot</span>
                </a>
            </li>

            <li>
                <a href="${pageContext.request.contextPath}/totalAchatVente">
                    <i class="zmdi zmdi-grid"></i> <span>Total Vente et Achat des Utilisateurs</span>
                </a>
            </li>

            <li>
                <a href="${pageContext.request.contextPath}/TransactionServlet">
                    <i class="zmdi zmdi-money"></i> <span>Transaction</span>
                </a>
            </li>

            <li>
                <a href="${pageContext.request.contextPath}/EchangeServlet">
                    <i class="zmdi zmdi-swap"></i> <span>Echange</span>
                </a>
            </li>
