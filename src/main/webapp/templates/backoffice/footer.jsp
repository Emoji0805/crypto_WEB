...
<!-- simplebar js -->
<script src="${pageContext.request.contextPath}/templates/assets/plugins/simplebar/js/simplebar.js"></script>
<!-- sidebar-menu js -->
<script src="${pageContext.request.contextPath}/templates/assets/js/sidebar-menu.js"></script>
<!-- loader scripts -->
<script src="${pageContext.request.contextPath}/templates/assets/js/jquery.loading-indicator.js"></script>
<!-- Custom scripts -->
<script src="${pageContext.request.contextPath}/templates/assets/js/app-script.js"></script>
<!-- Chart js -->

<script src="${pageContext.request.contextPath}/templates/assets/plugins/Chart.js/Chart.min.js"></script>

<!-- Index js -->
<script src="${pageContext.request.contextPath}/templates/assets/js/index.js"></script>
